...
int main(void)
{
	...
	pa = get_physical_address(heap_private_buf);
	
	printf("pa of step 4 = %lx\n", pa);
	...
	show_va_info(file_shared_buf);

	/* pa = get_physical_address(file_shared_buf);
	printf("pa of step 5 = %lx\n", pa); */
